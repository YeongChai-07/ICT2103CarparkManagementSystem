...
if (isset($_GET['return'])){
	...
	if ($array[0] == 1){
		echo "<script type='text/javascript'>alert('The location ({$array[1]}) of the season parking you added is already in the database.');</script>";
	}
}
                ...
                <div class="jumbotron">
                    ...
                    <div class="container">
                        <form method="post" action='seasonParking2.php'>
                            ...
                            <div class ="col-md-2">
								<div class="form-group">
									<select name="carpark" class="selectpicker" id = "carpark" onchange="showCost(this.value)" required>Carpark Name
										...
										if ($successfulConnection){
											...
											$query = "SELECT distinct(carparkLocation) AS carparkLocation, rate FROM carpark  ORDER BY carparkLocation ASC LIMIT 150";
									...
									<?php
										if (isset($_GET['return'])){
											if ($_GET['return'] == 1){
												echo "<label><font color='red'>{$array[1]} is already added!</font></label>";
											}
										}
									?>
								</div>
								...
								<p></p>
								<div class="form-group">
                                <input name="endDate" type="text" id="datepicker1" name="datepicker" required>
								</div>
                            </div>
							<div class="form-group">
								<div class ="row">
