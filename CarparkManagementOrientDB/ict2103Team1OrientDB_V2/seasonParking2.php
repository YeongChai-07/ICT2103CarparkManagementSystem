                ...
                <div class="jumbotron">
                    ...
                    <div class="container">
                        <form>
                            ...
                            <div class ="col-md-3">
                                <label for="SPcost">Blk 123</label>
                                <p> </p>
                                <label for="SPcost">$200</label>
                                <p> </p>
                                <label for="SPcost">10/10/2016</label>
                                <label for="SPcost">9/11/2016</label>
                    ...
                    <div class ="row">
                        ...
                        <div class ="col-md-1">
                            <a href="seasonParkingSuccessful.php" class="btn btn-default" role="button">Confirm</a>
                        </div>
                    </div>
                </div>
            </div>
