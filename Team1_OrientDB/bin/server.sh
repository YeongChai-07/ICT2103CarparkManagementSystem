...
exec "$JAVA" $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $DEBUG_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@r2a76ee1efc4487d9dc5f43e1ddc2fba1c5a0167c; 2016-10-20 13:55:08+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.12.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
